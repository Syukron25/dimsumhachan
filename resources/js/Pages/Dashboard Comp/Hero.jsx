export default function Hero (props){
    ...
    return(
      <div id="hero" className={`flex flex-col md:flex-row w-full py-28 px-2 items-center justify-center ${props.bg}`}>
        <div className="flex flex-col w-full  justify-center items-center md:items-end md:justify-end md:mr-48 bg-opacity-70  bg-white md:bg-transparent rounded-full py-10 md:scale-125">
          <p className="text-6xl text-teal-600 uppercase font-bold text-center pb-4 ">{props.title}</p>
          <p className="text-xl ">{props.line1}</p>
          <p className="text-xl  pb-4 ">{props.line2}</p>
