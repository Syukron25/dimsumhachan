    ...
    return(
        <>           
            <div id="kontak" className="flex flex-col p-1 pt-16 items-center justify-center">
                <p className=" font-black pb-2"> Kontak kami </p>
                <ul className="flex flex-col md:flex-row gap-8">
                    <li>
                        <a className="flex flex-col w-24 justify-center items-center text-center" href="https://www.facebook.com/profile.php?id=100020204730010" target="_blank">
                            <img src="https://img.icons8.com/?size=100&id=118497&format=png&color=000000" alt="" />
                            Hachan Abqari
                        </a>
                    </li>
                    <li>
                        <a className="flex flex-col w-24 justify-center items-center" href="https://www.instagram.com/dimsum_hachan/" target="_blank">
                            <img src="https://img.icons8.com/?size=100&id=Xy10Jcu1L2Su&format=png&color=000000" alt="" />
                            @dimsum_hachan</a></li>
                    <li>
                        <a className="flex flex-col w-24 justify-center items-center" href="https://wa.me/6283806651825">
            ...
            <div className="flex flex-col p-4 justify-center items-center">
                <p className="p-4 font-black"> Temukan pula kami di </p>
