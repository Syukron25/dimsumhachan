...
export default function Navbar(){
    ...
    const logo = <img src="https://img.icons8.com/?size=100&id=x0UMOekNtUEy&format=png&color=000000" className="h-9"></img>
    ...
    return (
        <>
            <section id="navbar" className={`flex fixed top-0 bg-white ${scroll ? 'bg-opacity-95' : 'bg-opacity-40 shadow-none'} w-full h-16 px-1 md:px-8 z-10  ${navshow ? '' : 'shadow-md'} `}>
